...
public class CustomSettingLock_Dialog {
    private Context context;

    public CustomSettingLock_Dialog(Context context){
    ...
    public void callFunction() {
        ...
        cl_camera.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ((settingpage) context).doTakePhotoAction();
                dlg.dismiss();
            }
        });
        ...
        cl_gallery.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                ((settingpage) context).doTakeAlbumAction();
                dlg.dismiss();
            }
        });
