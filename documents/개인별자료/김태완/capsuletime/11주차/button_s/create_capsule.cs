...
public class create_capsule : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        t_camera = GameObject.Find("ARCamera").transform;
    }

    public void tmpobject()
    {
        //new 버튼 클릭시 활성화 및 비활성화 목록
        t_camera.GetChild(1).gameObject.SetActive(true);
    ...
    public void newobject()
    {
        ...
        if (cancel_button.activeSelf == true)
        {
            ...
            //capsule 생성
            var c_parent = GameObject.Find("capsules").transform;
            var c_child = Instantiate(capsule);
            c_child.transform.SetParent(c_parent);
    ...
    public void cancelobejct()
    {
        ...
        t_camera.GetChild(1).gameObject.SetActive(false);
