...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        private void Start()
        {
            //기준 앵커 생성을 통해 상대적인 거리 및 회전율 확인
            //해당 기능으로 ar 화면에서의 오브젝트 위치 고정
            //현재 사용하는 기능의 전부
            var anchor = Session.CreateAnchor(new Pose(FirstPersonCamera.transform.position, Quaternion.identity));
            //var tmp_point = GameObject.Instantiate(capsule, anchor.transform.position, Quaternion.identity, anchor.transform);
        }
